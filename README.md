...
> Создано Романом для себя, чтобы быстро решать задачи по настройке редиректов на работе.
...
- Автоматическое экранирование спецсимволов в путях
- Предотвращение дубликатов правил
- Поддержка нескольких исходных URL для одного целевого
- Комментарии в выходном файле с указанием источника и количества правил
